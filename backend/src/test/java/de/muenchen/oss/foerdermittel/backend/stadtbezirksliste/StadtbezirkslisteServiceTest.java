...
class StadtbezirkslisteServiceTest {
    ...
    class GetStadtbezirksListeFormContext {
        ...
        void givenKurzbezeichnungenExists_thenReturnFormContext() {
            ...
            // When
            final StadtbezirkslisteFormContext result =
                    unitUnderTest.getStadtbezirksListeFormContext();
    ...
    class CreateListenname {
        ...
        void givenListenname_thenInsertEntity() {
            ...
            final Stadtbezirksliste assignment =
                    new Stadtbezirksliste(null, null, stadtbezirk, "Test");

            final Listenname entity =
                    new Listenname(KURZBEZ, BEZEICHNUNG, List.of(assignment));
    ...
    class UpdateListenname {
        ...
        void givenEntityExists_thenUpdateEntity() {
            ...
            final Stadtbezirksliste oldAssignment =
                    new Stadtbezirksliste(null, null, stadtbezirk, "old");

            final Listenname foundEntity =
                    new Listenname(KURZBEZ, "old", new java.util.ArrayList<>(List.of(oldAssignment)));

            final Stadtbezirksliste newAssignment =
                    new Stadtbezirksliste(null, null, stadtbezirk, "new");

            final Listenname updateEntity =
                    new Listenname(KURZBEZ, BEZEICHNUNG, List.of(newAssignment));
            ...
            // When
            final Listenname result =
                    unitUnderTest.updateListenname(updateEntity, KURZBEZ);
        ...
        void givenEntityNotExists_thenThrowNotFoundException() {
            // Given
            final Listenname entity =
                    new Listenname(KURZBEZ, BEZEICHNUNG, List.of());
