...
public class ListennameStadtbezirkslisteAssignmentMapperTest {
    ...
    private final ListennameStadtbezirkslisteAssignmentMapper mapper = Mappers.getMapper(ListennameStadtbezirkslisteAssignmentMapper.class);
    ...
    class ToEntity {
        ...
        void givenDTO_thenReturnsCorrectEntity() {
            // given
            StadtbezirkslisteAssignmentResponseDTO dto = new StadtbezirkslisteAssignmentResponseDTO(
                    BigDecimal.ONE,
                    "Altstadt",
                    "Test");
