...
class SiedlungsgebietIntegrationTest {
    ...
    public void setUp() {
        ...
        final Siedlungsgebiet exampleEntity = new Siedlungsgebiet(new BigDecimal(EXISTING_ID), "Test");
        siedlungsgebietRepository.save(exampleEntity);
    }
    ...
    class GetSiedlungsgebiet {
        ...
        void givenEntityNotExists_thenReturnNotFound() {
            restTestClient
                    .get()
                    .uri("/siedlungsgebiete/{id}", NON_EXISTING_ID)
                    .header(HttpHeaders.AUTHORIZATION, "Bearer sachbearbeitung")
                    .exchange()
    ...
    class GetSiedlungsgebiete {
        ...
        void givenPageable_thenReturnPageOfEntities() {
            restTestClient.get()
                    ...
                    .expectBody()
                    .jsonPath("$.content")
                    .value(new ParameterizedTypeReference<List<SiedlungsgebietResponseDTO>>() {
    ...
    class CreateSiedlungsgebiet {
        ...
        void givenEntityNotExists_thenEntityIsSaved() {
            final SiedlungsgebietCreateDTO requestDTO = new SiedlungsgebietCreateDTO(NON_EXISTING_ID, "Test");
            ...
            final SiedlungsgebietResponseDTO responseDTO = restTestClient.post()
                    ...
                    .value(response -> {
                        ...
                        assertThat(response.siedlungsgebiet()).isEqualTo(requestDTO.siedlungsgebiet());
        ...
        void givenEntityAlreadyExists_thenReturnConflict() {
            final SiedlungsgebietCreateDTO requestDTO = new SiedlungsgebietCreateDTO(EXISTING_ID, "Test");
        ...
        private static Stream<Arguments> invalidInputRequests() {
            return Stream.of(
                    arguments(
                            "siedlungsgebiet too high",
                            new SiedlungsgebietCreateDTO(100, "Test")),
                    arguments(
                            "bezeichnung too short",
                            new SiedlungsgebietCreateDTO(2, "")),
                    arguments(
                            "bezeichnung too long",
                            new SiedlungsgebietCreateDTO(2, "a".repeat(201))));
        }
    ...
    class UpdateSiedlungsgebiet {
        ...
        void givenEntityExists_thenEntityIsUpdated() {
            final SiedlungsgebietUpdateDTO requestDTO = new SiedlungsgebietUpdateDTO("Test aktualisiert");

            final SiedlungsgebietResponseDTO responseDTO = restTestClient.put()
                    .uri("/siedlungsgebiete/{id}", EXISTING_ID)
                    .header(HttpHeaders.AUTHORIZATION, "Bearer admin")
                    .body(requestDTO)
                    .accept(MediaType.APPLICATION_JSON)
        ...
        private static Stream<Arguments> invalidInputRequests() {
            return Stream.of(
                    arguments(
                            "bezeichnung too short",
                            new SiedlungsgebietUpdateDTO("")),
                    arguments(
                            "bezeichnung too long",
                            new SiedlungsgebietUpdateDTO("a".repeat(201))));
        }
    ...
    class GetSiedlungsgebietFormContext {
        ...
        void givenNoEntitiesExist_thenReturnEmptyFormContext() {
            ...
            assertThat(result.siedlungsgebiete()).isEmpty();
        }
