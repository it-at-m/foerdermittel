package de.muenchen.oss.foerdermittel.backend.archunit;
...
import de.muenchen.oss.foerdermittel.backend.archunit.rules.Rules;
...
public class ArchUnitTest {
    ...
    static void init() {
        allTestClasses = new ClassFileImporter()
                ...
                .importPackages(FoerdermittelBackendApplication.class.getPackage().getName());
    }
