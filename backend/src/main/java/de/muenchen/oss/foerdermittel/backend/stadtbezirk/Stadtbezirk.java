...
/**
 * This class represents a Stadtbezirk.
 * <p>
...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "stadtbezirke")
public class Stadtbezirk implements Serializable {
    ...
    @Id
    @NotNull @Min(0) @Max(99) private BigDecimal stadtbezirk;
