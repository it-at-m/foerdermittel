      ...
      <v-col cols="3">
        <fm-number-input
          ...
          :validation-attribute-map="
            BauprogrammCreateDTOPropertyValidationAttributesMap
          "
          validation-attribute-key="bauprogramm"
          :additional-rules="[
            rules['unique']!(
...
import { BauprogrammCreateDTOPropertyValidationAttributesMap } from "@/api/generated/foerdermittel-backend";
