...
(
    ...
    fob_fb              NUMERIC(2)                   NOT NULL REFERENCES fp_foerderbereiche (fb),
    ...
    bez_stadtbezirk     NUMERIC(2) REFERENCES fp_stadtbezirke (stadtbezirk),
    krn_krhname         VARCHAR(1) REFERENCES fp_krankenhaeuser (krhname),
    krhzweck            fp_projekte_krhzweck,
    krisofp             fp_projekte_krisofp,
    ...
    bpg_bauprogramm     NUMERIC(2) REFERENCES fp_bauprogramme (bauprogramm),
    sgt_siedlungsgebiet NUMERIC(2) REFERENCES fp_siedlungsgebiete (siedlungsgebiet),
    bauende             DATE,
    baubeendet          fp_projekte_baubeendet,
    bauvergabe1         DATE,
    baubeginn           DATE,
    baumitteilung       DATE,
...
(
    ...
    antragsdatum    DATE,
    antragstyp      fp_antraege_antragstyp       NOT NULL,
...
(
    ...
    erh_datum          DATE,
    ref_refnr          NUMERIC(2) REFERENCES fp_referate (refnr),
...
(
    hhj_jahr          NUMERIC(4)                            NOT NULL REFERENCES fp_hhjahre (hhjahr),
    pro_projnr        VARCHAR(7)                            NOT NULL REFERENCES fp_projekte (projnr),
...
(
    id               BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    jss_jahr         NUMERIC(4)  NOT NULL REFERENCES fp_jahresstatistik (jahr),
...
(
    ...
    bez_stadtbezirk NUMERIC(2) NOT NULL REFERENCES fp_stadtbezirke (stadtbezirk),
    bezeichnung     VARCHAR(200),
...
(
    ...
    ausbet       NUMERIC(10),
    erhdat       DATE,
    tra_kurzform NUMERIC(1) REFERENCES fp_traeger (kurzform),
    hst          VARCHAR(15),
    hulnr        VARCHAR(5),
    huljahr      NUMERIC(4),
    notizen      TEXT,
